...
export const SEED_CHADS: Chad[] = [
  ...
  // ─── PSL GODS / SUPERMODELS ────────────────────────────────
  {
    ...
    image: avatar('Francisco Lachowski'),
  ...
  },
  {
    ...
    slug: 'dillon-danis',
    handle: '@dillondanis',
    image: avatar('Dillon Danis'),
    bio: 'MMA fighter turned internet menace. Misfits LHW Champion. Chaos incarnate.',
    country: '🇺🇸',
    archetypes: ['gigachad', 'mogger'],
    mogTier: 'B',
    isLegacy: false,
    platforms: [
      { platform: 'instagram', username: 'dillondanis', followers: 7_000_000 },
      { platform: 'x', username: 'dloedanis', followers: 1_800_000 },
      { platform: 'tiktok', username: 'dillondanis', followers: 2_200_000 },
    ],
    score: {
      chadScore: 78.6,
      viralityScore: 92,
    ...
    sparklineData: sparkline(7_000_000, 'volatile'),
  },
  ...
  },
  {
    ...
    slug: 'dillon-latham',
    handle: '@dillonlatham',
    image: avatar('Dillon Latham'),
    bio: 'Grooming hacks. Quick looksmaxxing tips. The Cookie King. Skincare savant.',
    country: '🇺🇸',
    archetypes: ['prettyboy', 'mogger'],
    mogTier: 'B',
    isLegacy: false,
    platforms: [
      { platform: 'tiktok', username: 'dillonlatham', followers: 1_700_000 },
      { platform: 'instagram', username: 'dillonlatham', followers: 300_000 },
    ],
    score: {
      chadScore: 76.8,
      viralityScore: 80,
    ...
    sparklineData: sparkline(1_700_000, 'up'),
  },
  {
    id: '23',
    name: 'Hamza Ahmed',
    slug: 'hamza-ahmed',
    handle: '@hamza',
    image: avatar('Hamza Ahmed'),
    bio: 'Self-improvement meets looksmaxxing. 2M+ subs. Discipline, fitness, and fundamentals.',
    country: '🇬🇧',
    archetypes: ['mogger'],
    mogTier: 'B',
    isLegacy: false,
    platforms: [
      { platform: 'youtube', username: 'Hamza', followers: 2_000_000 },
      { platform: 'instagram', username: 'hamza', followers: 500_000 },
    ],
    score: {
      chadScore: 77.4,
      viralityScore: 75,
    ...
    sparklineData: sparkline(2_000_000, 'up'),
  },
];
