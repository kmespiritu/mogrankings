...
export const SEED_CHADS: Chad[] = [
  ...
  // ─── NEW ADDITIONS ────────────────────────────────────────
  {
    ...
    slug: 'tom-welling',
    handle: '@tomwelling',
    image: photo('tom-welling'),
    bio: 'Clark Kent himself. Prime Smallville era is one of the most mogged faces in TV history. The blueprint for the all-American jawline.',
    country: '🇺🇸',
    archetypes: ['prettyboy', 'gigachad'],
    mogTier: 'S',
    isLegacy: false,
    platforms: [
      { platform: 'instagram', username: 'tomwelling', followers: 2_800_000 },
    ],
    score: {
      chadScore: 90.5,
      viralityScore: 65,
    ...
    sparklineData: sparkline(2_800_000, 'flat'),
  },
  {
    id: '23',
    name: 'ASU Frat Leader',
    slug: 'asu-frat-leader',
    handle: '@asufratleader',
    image: photo('asu-frat-leader', 'png'),
    bio: 'The anonymous mog. No socials needed when your jawline does the talking. Community-submitted legend.',
    country: '🇺🇸',
    archetypes: ['gigachad', 'mogger'],
    mogTier: 'A',
    isLegacy: false,
    ...
    sparklineData: sparkline(1_000, 'flat'),
  },
];
